<div class="modal" id="modal_factura_manual">
      ...
      <div class="modal-body">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-4">
                ...
                <input type="search" onkeyup="mayus(this)"  class="form-control clear_input" name=""  id="cliente">
            </div>

            <div class="form-group col-md-3">
                <label for="ex3">Dirección</label>
                <input type="search" onkeyup="mayus(this)" class="form-control clear_input" name=""  id="dir">
            </div>
            ...
            <div class="form-group col-md-1">
                ...
                <input type="text"  class="form-control clear_input" name=""  id="num_factura">
            </div>
        </div>
