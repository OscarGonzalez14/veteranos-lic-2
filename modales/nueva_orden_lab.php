...
`
    ...
    if(valueSelect == "ingreso_manual"){
      ...
      cita_content.innerHTML = `
      <div class="form-row" id="show_form_manual">
              ...
              <input type="text" id="dui_pac" class="form-control">
              </div>

              <div class="form-group col-md-2">
              <label class="form-check-label">Edad*</label>
              <input type="text" id="edad_pac" class="form-control">
              </div>

              <div class="form-group col-md-2">
              <label class="form-check-label">Telefono*</label>
              <input type="text" id="telef_pac" class="form-control">
              </div>

              <div class="form-group col-md-2">
              <label class="form-check-label">Genero*</label>
              <select name="" id="genero_pac" class="form-control">
              ...
              <input type="text" id="ocupacion_pac" class="form-control">
              </div>

              <div class="form-group col-md-3 select2-purple">
              <label class="form-check-label">Departamento*</label>
              <select name="" id="departamento_pac" class="select2 form-control">
                <option value="" selected disabled>Selecionar</option>
              ...
              <select name="" id="munic_pac_data" class="select2 form-control">
                <option value="" selected disabled>Selecionar</option>
              ...
              <select name="" id="instit" class="form-control">
